...
{
//NORMAL GOLDEN PAN
//INCLUDED DUE TO THIS WEAPON CRASHING CLIENTS ON TF2ITEMSINFO USAGE
//SADLY THIS MEANS THE PAN WILL NEVER HAVE THE UNIQUE GOLD SKIN
//AS THAT IS LIKELY THE CAUSE OF THE CRASH
	SetTrieString(hItemInfoTrie, "1071_classname", "saxxy");
	SetTrieValue(hItemInfoTrie, "1071_index", 1071);
	SetTrieValue(hItemInfoTrie, "1071_slot", 2);
	SetTrieValue(hItemInfoTrie, "1071_quality", 9);
	SetTrieValue(hItemInfoTrie, "1071_level", 1);
	SetTrieString(hItemInfoTrie, "1071_attribs", "150 ; 1 ; 2025 ; 1");
	SetTrieValue(hItemInfoTrie, "1071_ammo", -1);
...
//OP VALVE FESTIVE ROCKET LAUNCHER 
//this is technically not a real valve weapon
	SetTrieString(hItemInfoTrie, "9511_classname", "tf_weapon_rocketlauncher");
	SetTrieValue(hItemInfoTrie, "9511_index", 658);
	SetTrieValue(hItemInfoTrie, "9511_slot", 0);
	SetTrieValue(hItemInfoTrie, "9511_quality", 8);
	SetTrieValue(hItemInfoTrie, "9511_level", 99);
	SetTrieString(hItemInfoTrie, "9511_attribs", "26 ; 500.0 ; 4 ; 900.0 ; 150 ; 1 ; 2 ; 1000 ; 57 ; 200 ; 31 ; 100 ; 134 ; 19 ; 2025 ; 1 ; 107 ; 3.0 ; 1007 ; 1 ; 1009 ; 1");
	SetTrieValue(hItemInfoTrie, "9511_ammo", 2700);	

//OP VALVE FESTIVE EYELANDER
//this is technically not a real valve weapon
	SetTrieString(hItemInfoTrie, "9522_classname", "tf_weapon_sword");
	SetTrieValue(hItemInfoTrie, "9522_index", 1082);
	SetTrieValue(hItemInfoTrie, "9522_slot", 2);
	SetTrieValue(hItemInfoTrie, "9522_quality", 8);
	SetTrieValue(hItemInfoTrie, "9522_level", 99);
	SetTrieString(hItemInfoTrie, "9522_attribs", "150 ; 1 ; 2 ; 1000 ; 57 ; 200 ; 31 ; 100 ; 134 ; 19 ; 60 ; -2.0 ; 62 ; -2.0 ; 64 ; -2.0 ; 66 ; -2.0 ; 2025 ; 1");
	SetTrieValue(hItemInfoTrie, "9522_ammo", -1);

//OP VALVE PRINNY MACHETE
//this is technically not a real valve weapon
	SetTrieString(hItemInfoTrie, "9533_classname", "saxxy");
	SetTrieValue(hItemInfoTrie, "9533_index", 30758);
	SetTrieValue(hItemInfoTrie, "9533_slot", 2);
	SetTrieValue(hItemInfoTrie, "9533_quality", 8);
	SetTrieValue(hItemInfoTrie, "9533_level", 99);
	SetTrieString(hItemInfoTrie, "9533_attribs", "150 ; 1 ; 2 ; 1000 ; 57 ; 200 ; 31 ; 100 ; 134 ; 19 ; 60 ; -2.0 ; 62 ; -2.0 ; 64 ; -2.0 ; 66 ; -2.0 ; 2025 ; 1");
	SetTrieValue(hItemInfoTrie, "9533_ammo", -1);

//OP VALVE FESTIVE MINIGUN 
//this is technically not a real valve weapon
	SetTrieString(hItemInfoTrie, "9544_classname", "tf_weapon_minigun");
	SetTrieValue(hItemInfoTrie, "9544_index", 654);
	SetTrieValue(hItemInfoTrie, "9544_slot", 0);
	SetTrieValue(hItemInfoTrie, "9544_quality", 8);
	SetTrieValue(hItemInfoTrie, "9544_level", 99);
	SetTrieString(hItemInfoTrie, "9544_attribs", "26 ; 500.0 ; 4 ; 900.0 ; 150 ; 1 ; 2 ; 1000 ; 57 ; 200 ; 31 ; 100 ; 134 ; 19 ; 2025 ; 1 ; 107 ; 3.0 ; 1007 ; 1 ; 1009 ; 1");
	SetTrieValue(hItemInfoTrie, "9544_ammo", 2700);	


//test with gun mettle using the brain candy minigun
//though this item has the quality set to valve
//this is technically not a real valve weapon
	SetTrieString(hItemInfoTrie, "9555_classname", "tf_weapon_minigun");
	SetTrieValue(hItemInfoTrie, "9555_index", 15098);
	SetTrieValue(hItemInfoTrie, "9555_slot", 0);
	SetTrieValue(hItemInfoTrie, "9555_quality", 8);
	SetTrieValue(hItemInfoTrie, "9555_level", 99);
	SetTrieString(hItemInfoTrie, "9555_attribs", "26 ; 500.0 ; 4 ; 900.0 ; 150 ; 1 ; 2 ; 1000 ; 57 ; 200 ; 31 ; 100 ; 134 ; 19 ; 2025 ; 1 ; 107 ; 3.0 ; 1009 ; 1");
	SetTrieValue(hItemInfoTrie, "9555_ammo", 2700);

//test with gun mettle using the lightning rod shotgun but this one is intended for the engi
//though this item has the quality set to valve
//this is technically not a real valve weapon
	SetTrieString(hItemInfoTrie, "9971_classname", "tf_weapon_shotgun");
	SetTrieValue(hItemInfoTrie, "9971_index", 15047);
	SetTrieValue(hItemInfoTrie, "9971_slot", 0);
	SetTrieValue(hItemInfoTrie, "9971_quality", 8);
	SetTrieValue(hItemInfoTrie, "9971_level", 99);
	SetTrieString(hItemInfoTrie, "9971_attribs", "150 ; 1 ; 2 ; 1000 ; 57 ; 200 ; 31 ; 30 ; 134 ; 19 ; 725 ; 0.400000005960464478 ; 60 ; -2.0 ; 62 ; -2.0 ; 64 ; -2.0 ; 66 ; -2.0");
	SetTrieValue(hItemInfoTrie, "9971_ammo", 2700);

//OP CAPPER
	SetTrieString(hItemInfoTrie, "9982_classname", "tf_weapon_pistol");
	SetTrieValue(hItemInfoTrie, "9982_index", 30666);
	SetTrieValue(hItemInfoTrie, "9982_slot", 1);
	SetTrieValue(hItemInfoTrie, "9982_quality", 8);
	SetTrieValue(hItemInfoTrie, "9982_level", 1);
	SetTrieString(hItemInfoTrie, "9982_attribs", "150 ; 1 ; 2 ; 9000 ; 6 ; 0.1 ; 4 ; 300 ; 26 ; 2000 ; 16 ; 250 ; 31 ; 20 ; 112 ; 25 ; 180 ; 500");
	SetTrieValue(hItemInfoTrie, "9982_ammo", 3000);


//OP GOLDEN PAN
	SetTrieString(hItemInfoTrie, "9986_classname", "saxxy");
	SetTrieValue(hItemInfoTrie, "9986_index", 1071);
	SetTrieValue(hItemInfoTrie, "9986_slot", 2);
	SetTrieValue(hItemInfoTrie, "9986_quality", 9);
	SetTrieValue(hItemInfoTrie, "9986_level", 1);
	SetTrieString(hItemInfoTrie, "9986_attribs", "150 ; 1 ; 2 ; 1000 ; 57 ; 200 ; 31 ; 30 ; 134 ; 17 ; 2025 ; 1 ; 1009 ; 1");
	SetTrieValue(hItemInfoTrie, "9986_ammo", -1);

//OP VALVE GOLDEN PAN
//this is technically not a real valve weapon
	SetTrieString(hItemInfoTrie, "9987_classname", "saxxy");
	SetTrieValue(hItemInfoTrie, "9987_index", 1071);
	SetTrieValue(hItemInfoTrie, "9987_slot", 2);
	SetTrieValue(hItemInfoTrie, "9987_quality", 8);
	SetTrieValue(hItemInfoTrie, "9987_level", 99);
	SetTrieString(hItemInfoTrie, "9987_attribs", "150 ; 1 ; 2 ; 1000 ; 57 ; 200 ; 31 ; 100 ; 134 ; 19 ; 60 ; -2.0 ; 62 ; -2.0 ; 64 ; -2.0 ; 66 ; -2.0 ; 2025 ; 1");
	SetTrieValue(hItemInfoTrie, "9987_ammo", -1);

//OP VALVE FESTIVE BLACK BOX
//this is technically not a real valve weapon
	SetTrieString(hItemInfoTrie, "9988_classname", "tf_weapon_rocketlauncher");
	SetTrieValue(hItemInfoTrie, "9988_index", 1085);
	SetTrieValue(hItemInfoTrie, "9988_slot", 0);
	SetTrieValue(hItemInfoTrie, "9988_quality", 8);
	SetTrieValue(hItemInfoTrie, "9988_level", 99);
	SetTrieString(hItemInfoTrie, "9988_attribs", "26 ; 500.0 ; 4 ; 900.0 ; 150 ; 1 ; 2 ; 1000 ; 57 ; 200 ; 31 ; 100 ; 134 ; 19 ; 2025 ; 1 ; 107 ; 3.0 ; 1007 ; 1 ; 1009 ; 1");
	SetTrieValue(hItemInfoTrie, "9988_ammo", 2700);	

//test with gun mettle using the lightning rod shotgun for non engi
//though this item has the quality set to valve
//this is technically not a real valve weapon
	SetTrieString(hItemInfoTrie, "9989_classname", "tf_weapon_shotgun");
	SetTrieValue(hItemInfoTrie, "9989_index", 15047);
	SetTrieValue(hItemInfoTrie, "9989_slot", 1);
	SetTrieValue(hItemInfoTrie, "9989_quality", 8);
	SetTrieValue(hItemInfoTrie, "9989_level", 99);
	SetTrieString(hItemInfoTrie, "9989_attribs", "150 ; 1 ; 2 ; 1000 ; 57 ; 200 ; 31 ; 30 ; 134 ; 19 ; 725 ; 0.400000005960464478 ; 60 ; -2.0 ; 62 ; -2.0 ; 64 ; -2.0 ; 66 ; -2.0");
	SetTrieValue(hItemInfoTrie, "9989_ammo", 2700);
